...
export async function createAllTables() {
   ...
   CREATE TABLE IF NOT EXISTS links (
          ...
          ('https://www.cockroachlabs.com/blog/what-is-connection-pooling/', 'What is Connection Pooling, and Why Should You Care?', 'Database connections can get expensive at scale. Pooling connections can help, so here''s what connection pooling is and how to do it!', 5, 7),
          ...
          ('https://www.youtube.com/watch?v=_Qzc0PgWEs8', 'Master Git from the inside!', 'Let''s break Git down and find out what''s actually going on behind the commands you''re getting your head around!', 1, 8),
         ('https://javascript.info/', 'JavaScript 101', 'A very comprehensive overview of JavaScript with tricksy tasks to complete at the end.', 1, 3),
         ('https://schoolofcode-bc13.slack.com/files/U043984UA04/F044NK6BGUU/git-cheat-sheet_1_.pdf?origin_team=T040S207AF7&origin_channel=C041JPAD3JL', 'Git Cheat Sheet', 'Haven''t mastered those pesky commands? Use our handy cheat sheet!', 1, 8),
         ...
         ('https://www.w3schools.com/jsref/dom_obj_event.asp', 'Events on the DOM', 'Just what IS a DOM tree? And how do I handle events? Get stuck in with explanations and examples.', 2, 3),
         ...
         ('https://rowanmanning.com/posts/javascript-for-beginners-async/', 'Asyncronous Functions', 'A beginner''s guide to using and understanding asyncronous functions.', 2, 3),
         ('https://www.boia.org/blog/googles-lighthouse-accessibility-tests-are-helpful-but-not-perfect', 'Lighthouse Accessibility Tests',	'Lighthouse tests are great, but they''re not perfect. What should we bear in mind when using them?', 3, 6),
         ...
         ('https://nordvpn.com/blog/what-is-my-port/', 'Understanding Ports', 'Where''s my port again? Super useful 2 minute guide for those times when your backend is becoming a pain in your backend.', 5, 6),
         ('https://stackoverflow.com/questions/28558920/postgresql-foreign-key-syntax', 'Foreign Keys in SQL ', 'Linking SQL tables can be hard to get your head around. What''s the best way to get it done?', 5, 6),
         ...
         ('https://www.tpgi.com/what-is-an-accessible-name/', 'Accessible HTML Names', 'Many HTML elements have an accessible name! Find out more here.',  6, 4),
         ('https://www.youtube.com/watch?v=4pO-HcG2igk', 'useState Hook', 'What''s a state and how do you use it? Seven minutes to master useState.', 7, 4),
         ('https://www.youtube.com/watch?v=PHaECbrKgs0', 'Props and Reusable Components', 'Nine minutes to get to grips with those React fundamentals. Very handy if you''re struggling with props!', 7, 4),
         ...
         ('https://react-hooks-cheatsheet.com/', 'React Hooks: A Cheat Sheet', 'From the everyday to the not-so-common, here are all the hooks you''ll ever need!', 7, 4),
         ...
         ('https://softwareengineering.stackexchange.com/a/65488', 'Unit Tests and Integration Tests', 'What''s the difference between unit and integration tests? Which should you be using and why?', 6, 6),
         ('https://www.freecodecamp.org/news/relational-vs-nonrelational-databases-difference-between-sql-db-and-nosql-db/',	'Relational and Non-Relational Databases',	'What''s the difference between an SQL and a No SQL database and when should you use each?', 5, 7),
